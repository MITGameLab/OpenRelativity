...
namespace OpenRelativity
{
    public class MovementScripts : MonoBehaviour
    {
        ...
        //            state.playerTransform.position = playerPos - ((Vector4)(stpiw.WorldToOptical(Vector3.zero, playerPos, playerVel))).OpticalToWorldHighPrecision(Vector3.zero, playerPos, playerVel);
        //        }
        //    }
        //}
