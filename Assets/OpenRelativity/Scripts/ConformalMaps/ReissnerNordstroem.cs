...
namespace OpenRelativity.ConformalMaps
{
    public class ReissnerNordstroem : Schwarzschild
    {
        ...
        public void SetEffectiveRadius(Vector3 piw)
        {
            invariantRadius = base.schwarzschildRadius;
            schwarzschildRadius = state.gConst * electricCharge * electricCharge / (state.SpeedOfLightSqrd * piw.magnitude);
        }

        public void ResetSchwarschildRadius()
        {
        ...
        override public void Update()
        {
            ...
            if (base.schwarzschildRadius <= 0 || !doEvaporate || state.isMovementFrozen)
            {
                return;
            }
